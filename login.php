        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
            ...
            if (mysqli_stmt_fetch($stmt)) {
                if ($status != 'verified') {
                    ...
                    $email_err = "Your account is not verified. Please check your email for verification instructions.";
                    ...
                    } elseif ($usertype == 'Delivery Boy') {
                        header("location: rider/delivery_dashboard.php");
                    }
                } else {
